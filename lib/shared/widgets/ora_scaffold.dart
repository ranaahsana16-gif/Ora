...
class _OraShellState extends ConsumerState<OraShell> {
      ...
      body: Builder(
        builder: (context) {
          ...
          Container(
            ...
            child: const Center(
              child: Text(
                'WE ARE OPEN FOR DELIVERY AND PICKUP!',
                style: TextStyle(
                  color: Colors.white,
                  fontSize: 12,
  ...
  Widget _buildFloatingCartBar(BuildContext context, int cartCount, {required bool isMobile}) {
